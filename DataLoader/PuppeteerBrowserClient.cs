...
{
    private readonly IBrowser _client;
    ...
    /// </summary>
    /// <returns></returns>
    private static async Task ThrowWhenClientBlocked(IPage page)
    {
    ...
    /// </summary>
    private static async Task<List<object>?> GetScriptsData(IPage page)
    {
